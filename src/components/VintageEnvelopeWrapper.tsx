      ...
      {!isOpen ? (
        ...
        >
          ...
          <div className="relative w-full max-w-lg mx-auto my-auto text-center">
            ...
            >
              ...
              <div className="space-y-6 my-6 relative z-10">
                ...
                <div className="py-3 border-y border-[#D4A359]/40 my-2 max-w-xs mx-auto">
                  <h1 className="text-xl sm:text-2xl font-serif tracking-widest text-[#1E3A2B] font-bold uppercase leading-relaxed">
                    You Are Cordially <br />
                    <span className="text-[#C15C3D]">Invited</span>
                  </h1>
                </div>
            ...
            {/* Sub-note */}
            <p className="mt-4 text-xs font-sans text-[#F5ECE0]/70 text-center">
              Click anywhere on the vintage envelope to unseal and enter
            </p>
