        ...
        <div className="text-center space-y-4 border-2 border-[#D4A359]/70 p-4 sm:p-6 rounded-2xl bg-[#FDF8F2] relative overflow-hidden my-2">
          ...
          <div className="relative z-10 space-y-3 px-2 sm:px-4 py-2">
            ...
            <h1 className="text-xl sm:text-2xl font-serif tracking-widest text-[#C15C3D] font-bold uppercase leading-snug">
              Ngasya &amp; Mathaa <br />
              <span className="text-[#1E3A2B]">Ceremony</span>
            </h1>

            <div className="py-2">
              <h2 className="font-script text-4.5xl sm:text-6xl text-[#B93815] font-bold drop-shadow-2xs leading-tight">
                Virginia Mutuku
              </h2>
              <div className="font-script text-3xl sm:text-4xl text-[#B8860B] font-bold my-0.5">&amp;</div>
              <h2 className="font-script text-4.5xl sm:text-6xl text-[#B93815] font-bold drop-shadow-2xs leading-tight">
                Kenneth Abonyo
              </h2>
            </div>
            ...
            <p className="text-[11px] text-[#2C4C3B] italic max-w-xs mx-auto">
              Together with our families, we joyfully invite you to our Ngasya &amp; Mathaa ceremony.
            </p>

            {/* Bible Verse Scripture Accent */}
            <div className="my-2 p-3 bg-[#FEF9C3] rounded-xl border-2 border-[#EAB308] text-center shadow-2xs">
              <p className="font-serif italic text-xs sm:text-sm text-[#111827] font-bold leading-tight">
                “{WEDDING_DETAILS.bibleVerse.text}”
              </p>
              <p className="text-[10px] font-sans tracking-widest font-bold text-[#EA580C] uppercase mt-1">
